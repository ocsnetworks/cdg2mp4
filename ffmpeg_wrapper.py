...
class KaraokeConverter:
    ...
    def convert_to_mp4(self):
        ...
        try:
            ...
            proc = subprocess.run(["ffmpeg", '-i', self.cdg, '-i', self.mp3, '-s', '640x480', '-r', '30', '-acodec', 'copy', '-vcodec', 'libx264', '-pix_fmt', 'yuv420p', '-crf', '18', '-f', 'mp4', self.mp4 ], stdout=subprocess.PIPE)
